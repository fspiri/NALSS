...
public class Octahedron implements ConvexHull{
    double angle = 0;
    ...
    public void updateEdges(){
        ...
        edges.add(new Line(proj_vertices[0][0] * growth + displaceX , proj_vertices[0][1] * growth + displaceY, proj_vertices[5][0] * growth + displaceX, proj_vertices[5][1] * growth + displaceY));
        ...
        edges.add(new Line(proj_vertices[2][0] * growth + displaceX , proj_vertices[2][1] * growth + displaceY, proj_vertices[4][0] * growth + displaceX, proj_vertices[4][1] * growth + displaceY));
        ...
        edges.add(new Line(proj_vertices[3][0] * growth + displaceX , proj_vertices[3][1] * growth + displaceY, proj_vertices[4][0] * growth + displaceX, proj_vertices[4][1] * growth + displaceY));

        /*

        edges.add(new Line(proj_vertices[0][0] * growth + displace , proj_vertices[0][1] * growth + displace, proj_vertices[3][0] * growth + displace, proj_vertices[3][1] * growth + displace));
        edges.add(new Line(proj_vertices[0][0] * growth + displace , proj_vertices[0][1] * growth + displace, proj_vertices[4][0] * growth + displace, proj_vertices[4][1] * growth + displace));

        edges.add(new Line(proj_vertices[1][0] * growth + displace , proj_vertices[1][1] * growth + displace, proj_vertices[2][0] * growth + displace, proj_vertices[2][1] * growth + displace));
        edges.add(new Line(proj_vertices[1][0] * growth + displace , proj_vertices[1][1] * growth + displace, proj_vertices[5][0] * growth + displace, proj_vertices[5][1] * growth + displace));

        edges.add(new Line(proj_vertices[2][0] * growth + displace , proj_vertices[2][1] * growth + displace, proj_vertices[3][0] * growth + displace, proj_vertices[3][1] * growth + displace));
        edges.add(new Line(proj_vertices[2][0] * growth + displace , proj_vertices[2][1] * growth + displace, proj_vertices[6][0] * growth + displace, proj_vertices[6][1] * growth + displace));

        edges.add(new Line(proj_vertices[3][0] * growth + displace , proj_vertices[3][1] * growth + displace, proj_vertices[7][0] * growth + displace, proj_vertices[7][1] * growth + displace));

        edges.add(new Line(proj_vertices[4][0] * growth + displace , proj_vertices[4][1] * growth + displace, proj_vertices[5][0] * growth + displace, proj_vertices[5][1] * growth + displace));
        edges.add(new Line(proj_vertices[4][0] * growth + displace , proj_vertices[4][1] * growth + displace, proj_vertices[7][0] * growth + displace, proj_vertices[7][1] * growth + displace));

        edges.add(new Line(proj_vertices[5][0] * growth + displace , proj_vertices[5][1] * growth + displace, proj_vertices[6][0] * growth + displace, proj_vertices[6][1] * growth + displace));
        edges.add(new Line(proj_vertices[6][0] * growth + displace , proj_vertices[6][1] * growth + displace, proj_vertices[7][0] * growth + displace, proj_vertices[7][1] * growth + displace));
